...
RSpec.describe "in_proceedings/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit in_proceeding form" do
    render

    assert_select "form[action=?][method=?]", in_proceeding_path(@in_proceeding), "post" do
